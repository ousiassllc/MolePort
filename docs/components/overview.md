...
graph TD
    ...
    subgraph "TUI Layer"
        ...
        ThemePg["pages/themepage.go"]
        LangPg["pages/langpage.go"]
...
### Resolver (`i18n/resolver.go`)

言語の自動解決を担う。

#### 責務

- config.yaml の `language` フィールドの読み取り
...
func NewThemePage(currentPresetID string, width, height int) ThemePage
...
func NewLangPage(currentLang i18n.Lang, width, height int) LangPage
